...
namespace GlitchTrace.Controllers
{
    [Authorize]
    public class ProjectsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjectId,Name,Description,StartDate,EndDate,CreatedOn,CreatedBy")] Project project)
        {
